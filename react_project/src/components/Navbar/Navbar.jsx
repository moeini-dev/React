    ...
    <>
      ...
      <div className="bottom">
        ...
        <div style={{ display: 'flex', flexDirection: 'row' }}>
          ...
          {user?.user?.username && user?.user?.isAdmin == true ? <Link to={'/book/addBook'} className="newBook">New Book</Link> : <div></div>}
